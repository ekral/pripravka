...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        {
            ImGui::Begin("Vypocet hypoteky");                          

            ImGui::SliderFloat("Castka", &D, 400000.0f, 10000000.0f);            
            ImGui::SliderInt("Urok", &urok, 1, 20);
            ImGui::SliderInt("Pocet let", &pocetLet, 5, 40.0);
